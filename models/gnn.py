...
class GatedGNN(nn.Module):
    ...
    def compute_node_representations(self,
        ...
        for edge_type_idx, adjacency_list_for_edge_type in enumerate(adjacency_lists):
            if adjacency_list_for_edge_type.num_edge > 0:
...
if __name__ == '__main__':
    gnn = GatedGNN(hidden_size=256, num_edge_types=4,
                   layer_timesteps=[8, 8, 8, 8, 8], residual_connections={})

    adj_list_type1 = AdjacencyList(num_node=4, adj_list=[(0, 0), (1, 1), (2, 3), (3, 3)], device=gnn.device)
    adj_list_type2 = AdjacencyList(num_node=4, adj_list=[(0, 0), (0, 1)], device=gnn.device)
